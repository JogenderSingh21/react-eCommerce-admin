...
import userSix from '../images/user/avatar.svg';
      ...
      <div className="overflow-hidden rounded-2xl border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
        ...
        <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
          ...
          <div className="mt-4">
            ...
            <div className="mx-auto mt-4.5 mb-5.5 grid max-w-94 grid-cols-3 rounded-xl border border-stroke py-2.5 shadow-1 dark:border-strokedark dark:bg-[#37404F]">
            ...
            <div className="mt-6.5">
              ...
              <div className="flex items-center justify-center gap-3.5">
                <a
                  href="https://www.instagram.com/jojo_sehrawat_26"
                  target="_blank"
                ...
                <a
                  href="https://www.linkedin.com/in/jogender-singh-510865246"
                  target="_blank"
                  className="hover:text-primary"
                  aria-label="social-icon"
                >
                ...
                <a
                  href="https://www.github.com/JogenderSingh21"
                  target="_blank"
                  className="hover:text-primary"
                  aria-label="social-icon"
                >
