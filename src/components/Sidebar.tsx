...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    <aside
      ref={sidebar}
      className={`absolute left-0 top-0 z-9999 flex h-screen w-64 flex-col overflow-y-hidden bg-white duration-300 ease-linear dark:bg-boxdark lg:static lg:translate-x-0 ${
    ...
    >
        ...
        <NavLink to="/">
          ...
          <div className="flex items-center">
            <img
              ...
              alt="logo"
            ></img>
            <h1 className="text-slate-600 font-bold text-3xl dark:text-white">
              Admin
            </h1>
          </div>
        </NavLink>
      ...
      <div className="no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear">
        ...
        <nav className="py-4 px-4 lg:px-6">
          {/* <!-- Menu Group --> */}
          <div>
            {/* <h3 className="mb-4 ml-4 text-sm font-semibold text-slate-600 dark:text-bodydark2">
              MENU
            </h3> */}
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                <NavLink
                  to="/"
                  className={`group relative flex items-center gap-2.5 rounded-xl px-4 py-3.5 font-medium text-slate-500 dark:text-bodydark1 duration-300 ease-in-out hover:bg-slate-100 dark:hover:bg-meta-4 ${
                    (pathname === '/' || pathname.includes('dashboard')) &&
                    'bg-slate-200 hover:bg-slate-200 dark:bg-meta-4'
                  }`}
                >
                  <svg
                    className="fill-current"
              ...
              <li>
                ...
                >
                  ...
                  >
                    ...
                    <polyline
                      className="st0"
                      points="18,18 18,10 23,10 26,14 26,18 24,18 "
                    />
                    <line className="st0" x1="4" y1="10" x2="13" y2="10" />
                    <line className="st0" x1="2" y1="13" x2="11" y2="13" />
                    <rect
                      x="-288"
                      y="-576"
                      className="st3"
